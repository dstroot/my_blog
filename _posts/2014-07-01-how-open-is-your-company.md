...
<!-- more -->
Over the past several years huge strides have been made by the "Open Government" movement. Today:

* Citizens and government leaders alike expect government data to be accessible and transparent. 
...
### It's progressed quicker than we expected

1. The United States Government maintains its [Open Data Policy](https://github.com/project-open-data/project-open-data.github.io) on Github! Anyone can fork the policy, edit it, and submit a pull request to have their edits adopted in a fully open and transparent process just like creating open source software. 
2. The International Organization for Standardization (ISO) has published a set of standards ([ISO 37120](https://www.iso.org/obp/ui/#iso:std:iso:37120:ed-1:v1:en)) that specifies the relevant metrics for city services and quality of life. This standard will let researchers and citizens evaluate any city based on a uniform set of metrics. Furthermore, ISO 37120 confirms and accelerates the momentum of the open data movement and now provides a common framework within which all cities can participate. It is a gateway to smarter cities (and citizens).
3. Cities have embraced the open government movement and opened up their data to the public. Here are some examples:
...
and the underlying datasets supporting the metrics must be publicly available, along with other supporting data.
...
* Integrated data from open sources and social media allows a 360-degree view of customers, suppliers, products and markets and can generate new product ideas.
